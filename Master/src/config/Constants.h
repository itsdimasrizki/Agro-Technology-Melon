...
constexpr uint32_t PRE_MIX_TANK_TIME       = 1000UL;
constexpr uint32_t PRE_MIX_CORRECTION_TIME = 1000UL;
constexpr uint32_t MIX_A_TIME              = 1000UL;
constexpr uint32_t MIX_B_TIME              = 1000UL;
#else
...
#if ENABLE_FSM_SIMULATION_TEST
constexpr unsigned long CORRECTION_MIX_TIME = 1000UL;
constexpr uint32_t      PRE_IRRIGATION_MIX_TIME = 1000UL;
constexpr uint32_t      CORRECTION_DELAY    = 1000UL;
#else
