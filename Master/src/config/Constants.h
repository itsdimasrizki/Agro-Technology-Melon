...
// Solenoid ditutup sebelum target untuk mengompensasi delay valve dan sisa air di pipa.
// Nilai awal ini WAJIB dikalibrasi ulang di lapangan.
constexpr float          FILL_STOP_MARGIN_LITER      = 0.3f;
// Durasi level harus stabil (tidak berubah) setelah solenoid ditutup sebelum FSM lanjut ke PRE_MIX_A
