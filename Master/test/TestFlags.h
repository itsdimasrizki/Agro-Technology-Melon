...
// Kalibrasi flow sensor & dead volume selang:
// Set A=1 untuk test Pompa A + Solenoid A saja (relay lain mati).
// Set B=1 untuk test Pompa B + Solenoid B saja (relay lain mati).
// Lihat Serial Monitor untuk pembacaan volume & flow rate real-time.
